"Resource/UI/MainMenuOverride.res"
{
	...
	"vVersionLabel"
	{
		...
		"enabled"		"1"
		"textAlignment"	"center"
		"labelText"		"voidHUD Rewrite Beta 10.20.2020"
		"fgcolor"		"vWhite255"
		"font"			"s12"
	}
	...
	"Notifications_ShowButtonPanel"
	{
		...
		"SubImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"replay/thumbnails/mainmenu/icon_info"
			"scaleImage"	"1"
			"proportionaltoparent"	"1"
		}				
	...
	"WatchStreamButton"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"enabled"		"1"
				"scaleImage"	"1"
				"image"			"replay/thumbnails/mainmenu/icon_streams"
	...
	"QuestLogButton"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"enabled"		"1"
				"scaleImage"	"1"
				"image"			"replay/thumbnails/mainmenu/icon_contract"
	...
	"MOTD_ShowButtonPanel"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"replay/thumbnails/mainmenu/icon_inbox"
				"scaleImage"	"1"
			}
		}
	}
	...
	"FriendsContainer"
	{
		...
		"SteamFriendsList"
		{
			...
			"ScrollBar"
			{
				...
				"Slider"
				{
					"fgcolor_override"	"vLightGray255"
				}
	...
	"ReportPlayerButton"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"replay/thumbnails/mainmenu/icon_flag"
				"scaleImage"	"1"
				"proportionaltoparent"	"1"
			}				
		}
	...
	"CallVoteButton"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"replay/thumbnails/mainmenu/icon_megaphone"
				"scaleImage"	"1"
				"proportionaltoparent"	"1"
			}				
		}
	...
	"MutePlayersButton"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"replay/thumbnails/mainmenu/icon_mute"
				"scaleImage"	"1"
				"proportionaltoparent"	"1"
			}				
		}
	...
	"RequestCoachButton"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"replay/thumbnails/mainmenu/icon_lightbulb"
				"scaleImage"	"1"
				"proportionaltoparent"	"1"
			}				
		}
	...
	{
		"ControlName"	"EditablePanel"
		"fieldName"		"vCharacterSetupButton"
		"xpos"			"c-94"
		"ypos"			"c83"
		"zpos"			"1"
		"wide"			"32"
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"enabled"		"1"
				"scaleImage"	"1"
				"image"			"replay/thumbnails/mainmenu/icon_safe"
				"proportionaltoparent"	"1"
			}		
		}
	}
	...
	"vGeneralStoreButton"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"enabled"		"1"
				"scaleImage"	"1"
				"image" "replay/thumbnails/mainmenu/icon_shopping_cart"
				"proportionaltoparent"	"1"
			}		
		}
	}
	...
	"vSettingsButton"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"enabled"		"1"
				"scaleImage"	"1"
				"image"			"replay/thumbnails/mainmenu/icon_cog"
				"proportionaltoparent"	"1"
			}			
		}
	}
	...
	"NewUserForumsButton"
	{
		...
		"SubImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"replay/thumbnails/mainmenu/icon_star"
			"scaleImage"	"1"
			"proportionaltoparent"	"1"
		}				
	}		
	...
	"AchievementsButton"
	{
		...
		"SubImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"replay/thumbnails/mainmenu/icon_trophy"
			"scaleImage"	"1"
			"proportionaltoparent"	"1"
		}				
	}		
	...
	"CommentaryButton"
	{
		...
		"SubImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"replay/thumbnails/mainmenu/icon_speaker"
			"scaleImage"	"1"
			"proportionaltoparent"	"1"
		}				
	}		
	...
	"WorkshopButton"
	{
		...
		"SubImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"replay/thumbnails/mainmenu/icon_cloud"
			"scaleImage"	"1"
			"proportionaltoparent"	"1"
		}				
	}	
	...
	"ReplayButton"
	{
		...
		"SubImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"replay/thumbnails/mainmenu/icon_video_camera"
			"scaleImage"	"1"
			"proportionaltoparent"	"1"
		}				
	}
	...
	"ReportBugButton"
	{
		...
		"SubImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"replay/thumbnails/mainmenu/icon_edit"
			"scaleImage"	"1"
			"proportionaltoparent"	"1"
		}				
	}			
	...
	"ConsoleButton"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"replay/thumbnails/mainmenu/icon_atomic"
				"scaleImage"	"1"
				"proportionaltoparent"	"1"
			}				
		}
	...
	"DemoUIButton"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"replay/thumbnails/mainmenu/icon_monitor"
				"scaleImage"	"1"
				"proportionaltoparent"	"1"
			}				
		}
	...
	"DiscordButton"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"replay/thumbnails/mainmenu/icon_discord"
				"scaleImage"	"1"
				"proportionaltoparent"	"1"
			}				
		}
